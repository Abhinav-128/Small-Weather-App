...
def WeatherUpdate():
        ...
        try:
           ...
           print("Current weather in",city,"of", country,"of Region",region,"at",currentTime,"is ",description, "and the temprature is ",temp,"C and feels like",tempFeel,f"C, with humidity {humdity}% and Air Conditions are",aqi)
           print("")
              ...
              print(f"Error: The city '{city}' was not found in the weather database.{err}")
